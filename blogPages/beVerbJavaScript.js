...
function checkTranslation1() {
    ...
    const translationAnsContainer1 = document.getElementById("translationExplanation1");
    ...
    if (translation1 === "I am scared." || translation1 === "I am afraid.") {
        translationAnsContainer1.appendChild(answerContainer1).appendChild(trans1Right);
    } else if (translation1 == "") {
        translationAnsContainer1.appendChild(answerContainer1).appendChild(trans1NoAns);
    } else if (translation1 != "I am scared." || "I am afraid.") {
        translationAnsContainer1.appendChild(answerContainer1).appendChild(trans1Wrong);
    };
};
...
function checkTranslation2() {
    ...
    const trans2Wrong = document.createTextNode("That's not quite what I would use. Here are the answers I was thinking of: 'This is Gary. He is strict.' Be sure to check your spelling and punctuation!");
    const trans2NoAns = document.createTextNode("You did not submit answer.");
    const translationAnsContainer2 = document.getElementById("translationExplanation2");
    ...
    if (translation2 === "This is Gary. He is strict.") {
        translationAnsContainer2.appendChild(answerContainer2).appendChild(trans2Right);
    } else if (translation2 == "") {
        translationAnsContainer2.appendChild(answerContainer2).appendChild(trans2NoAns);
    } else if (translation2 != "This Gary. He is strict.") {
        translationAnsContainer2.appendChild(answerContainer2).appendChild(trans2Wrong);
    };
};
...
function checkTranslation3() {
    ...
    const translationAnsContainer3 = document.getElementById("translationExplanation3");
    ...
    if (translation3 === "They are cool." ) {
        translationAnsContainer3.appendChild(answerContainer3).appendChild(trans3Right);
    } else if (translation3 == "") {
        translationAnsContainer3.appendChild(answerContainer3).appendChild(trans3NoAns);
    } else if (translation3 != "They are cool.") {
        translationAnsContainer3.appendChild(answerContainer3).appendChild(trans3Wrong);
    } 
